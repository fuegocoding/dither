...
export function Dropzone({
  ...
  return (
    <div
      ...
      onClick={() => inputRef.current?.click()}
      className={cn(
        "group relative flex cursor-pointer flex-col items-center justify-center gap-4 border-2 border-dashed bg-muted/35 px-6 py-16 text-center transition-all backdrop-blur-sm",
        isOver
          ? "border-primary bg-primary/5"
          : "border-border hover:border-primary/50 hover:bg-muted/45",
